export const serviceData = [
  {
    id: 1,
    thumb: "tier_class.webp",
    title: "Tier Classification",
    description:
      "Every registered FPO on the platform is automatically placed into a tier — Tier A, B, C, or D — based on the information provided during registration, like membership size, activity level, and other performance indicators set by KAU. (Please Login to use this feature.)",
  },
  {
    id: 2,
    thumb: "dpr.webp",
  ...
  {
    id: 9,
    thumb: "crop_recommendation.webp",
