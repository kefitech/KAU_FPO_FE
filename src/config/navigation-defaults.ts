  ...
  groups: [
    {
      ...
      items: [
        ...
        { id: "team", title: "Team", translations: { ml: "ടീം" }, url: "/fpo/team", icon: "Users" },
        {
          id: "products",
          title: "My Products",
          translations: { ml: "എന്റെ ഉൽപ്പന്നങ്ങൾ" },
          url: "/fpo/products",
          icon: "Package",
        },
        {
        ...
        { id: "schemes", title: "Schemes", translations: { ml: "പദ്ധതികൾ" }, url: "/fpo/schemes", icon: "FileText" },
        {
          ...
          translations: { ml: "വിദഗ്ധ ഡയറക്ടറി" },
          url: "/fpo/experts",
          icon: "BookOpen",
        },
        {
          ...
          translations: { ml: "ടയർ അസസ്മെന്റ്" },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          translations: { ml: "ഉപയോക്തൃ മാനേജ്‌മെന്റ്" },
          url: "/admin/users",
          icon: "Users",
        },
      ...
      items: [
        {
          ...
          translations: { ml: "റിപ്പോർട്ടുകൾ ജനറേറ്റ് ചെയ്യുക" },
          url: "/admin/reports",
          icon: "ClipboardList",
        },
      ],
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          translations: { ml: "സ്കീം ലിങ്കേജ്" },
